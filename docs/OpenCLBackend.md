...
Also some GPUs - all of them are mobile GPUs -  don't have such local memory and is emulated using global memroy. Etaler currently can't see that and results in lower performance. 
