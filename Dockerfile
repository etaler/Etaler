...
RUN apt-get update && apt-get install -y g++  wget git opencl-headers ocl-icd-opencl-dev libcereal-dev sudo nano cmake apt-utils libtbb-dev gdb python python-numpy python-numpy-dev python-matplotlib
...
wget  https://raw.githubusercontent.com/lava/matplotlib-cpp/master/matplotlibcpp.h -P /usr/include/
